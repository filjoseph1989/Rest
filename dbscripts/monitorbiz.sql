...
CREATE TABLE IF NOT EXISTS `sites` (
  ...
  `site_group_id` int(11) unsigned NOT NULL DEFAULT '1',
  `website_group_id` int(11) unsigned DEFAULT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The list of sites';

-- Dumping data for table monitorbiz.sites: ~0 rows (approximately)
DELETE FROM `sites`;
/*!40000 ALTER TABLE `sites` DISABLE KEYS */;
INSERT INTO `sites` (`id`, `site_id`, `site_group_id`, `website_group_id`, `name`, `title`, `today_avg_position`, `yesterday_avg_position`, `total_up`, `total_down`, `keys_count`, `process`) VALUES
	(1, '1', 2, 3, 'sample', 'sample title', 1, 2, 5, 6, 7, 1);
...
CREATE TABLE IF NOT EXISTS `site_search_engines` (
  ...
  `site_engine_id` int(11) DEFAULT NULL,
